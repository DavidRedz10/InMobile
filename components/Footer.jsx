    ...
    <div class="p-5 bg-gray-100 rounded-lg py-12 m-5">
        ...
        <div class="">
            <ul class="flex flex-row space-x-4 justify-center">
                <li>
                    <a href="https://www.facebook.com/davidalejandro.rojasespejo" target="_blank" rel="nofollow">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/davidredz10/" target="_blank" rel="nofollow">
